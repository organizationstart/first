...
public class Cliente_ESTest extends Cliente_ESTest_scaffolding {
  ...
  // Testes criados por Isaac Daniel Bezerra
  @Test(tmeout = 400)
  public void testEmail() throws Throwable {
	  Carteira carteira0 = new Carteira(200, 300, 350);
	  Cliente cliente0 = new Cliente("Isaac", 20, "email@email.kin", "88999966777", carteira0);
	  
	  assertNotNull(cliente0.getEmail());
  }
  
  @Test(timeout = 4000)
  public void testSetEmail()  throws Throwable  {
      Carteira carteira0 = new Carteira(0, 0, 0);
      Cliente cliente0 = new Cliente("Isaac", 20, "email@email.kin", "99999999999", carteira0);
      
      cliente0.setEmail("teste@teste.kin");
      String emailAtual = cliente0.getEmail();
      assertEquals("teste@teste.kin", emailAtual);
  }
